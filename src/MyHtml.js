...
export default function MyHtml(props) { 
  ...
  useFrame(({camera, clock}) => {
    ...
    group1.current.quaternion.copy(camera.quaternion) // Make text face the camera
    ...
    group2.current.quaternion.copy(camera.quaternion)
  })
            ...
            <Html transform scale={0.8}>
                <div className="card border-light mb-3" style={{width: '600px'}}>
                    <div className="card-body">
                        ...
                        J'ai créé mes premiers sites en 1998 (Ifremer / Alcatel Lannion) et je suis tombé amoureux d'Internet, du code et du multimédia. Depuis 24 ans, je n'ai jamais cessé d'apprendre. Je suis spécialisé dans le développement front et back-end de sites mobiles et web et expert dans de nombreux domaines.<br/>
                        ...
                        <p>Je conçois et code mais, au besoin, je m'occupe aussi de : design, cahier des charges, gestion de projet, planning, formations, démonstrations techniques/marketing, community management, ...</p>
                        <p><strong>Freelance web • Conception Internet • Consultant • Formation • E-commerce • Réseaux sociaux • Metaverse • A l'écoute du marché</strong></p>
                        <h3 className="text-center">Connectons-nous !</h3>
                        <ul className="list-unstyled">
                            <li>
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#b71968">
                            ...
                            <li>
                                <svg viewBox="0 0 30 25" width="24" height="24" fill="#b71968">
                                ...
                                <span>Réseau : <a href="https://twitter.com/molokoloco">@molokoloco</a> sur Twitter</span>
                            </li>
                            <li>
                                <svg viewBox="0 0 30 30" width="24" height="24" fill="#b71968">
                                ...
                                <span>Curriculum : <a href="https://www.linkedin.com/in/julien-guezennec/">@julien-guezennec</a> sur LinkedIn</span>
                            </li>
                            <li>
                                <svg viewBox="0 0 30 30" width="24" height="24" fill="#b71968">
                                    <path d="M 15 0.371094 C 6.710938 0.371094 0 7.085938 0 15.371094 C 0 22 4.296875 27.621094 10.257812 29.601562 C 11.007812 29.742188 11.28125 29.28125 11.28125 28.882812 C 11.28125 28.523438 11.269531 27.582031 11.261719 26.332031 C 7.089844 27.234375 6.210938 24.320312 6.210938 24.320312 C 5.527344 22.585938 4.542969 22.125 4.542969 22.125 C 3.183594 21.195312 4.644531 21.214844 4.644531 21.214844 C 6.152344 21.320312 6.945312 22.757812 6.945312 22.757812 C 8.28125 25.050781 10.453125 24.390625 11.3125 24.007812 C 11.449219 23.035156 11.832031 22.375 12.261719 22 C 8.929688 21.625 5.429688 20.335938 5.429688 14.585938 C 5.429688 12.949219 6.011719 11.613281 6.972656 10.5625 C 6.804688 10.183594 6.296875 8.660156 7.105469 6.59375 C 7.105469 6.59375 8.359375 6.191406 11.230469 8.128906 C 12.429688 7.796875 13.703125 7.632812 14.980469 7.625 C 16.253906 7.632812 17.53125 7.796875 18.730469 8.128906 C 21.578125 6.191406 22.835938 6.59375 22.835938 6.59375 C 23.640625 8.660156 23.136719 10.183594 22.984375 10.5625 C 23.941406 11.613281 24.523438 12.949219 24.523438 14.585938 C 24.523438 20.351562 21.015625 21.617188 17.679688 21.988281 C 18.203125 22.4375 18.691406 23.359375 18.691406 24.761719 C 18.691406 26.769531 18.671875 28.382812 18.671875 28.871094 C 18.671875 29.265625 18.9375 29.734375 19.703125 29.582031 C 25.707031 27.613281 30 21.988281 30 15.371094 C 30 7.085938 23.285156 0.371094 15 0.371094 ">
                                    </path>
                                </svg>
                                <span>Code : <a href="https://github.com/molokoloco/">@julien-gueznet</a> sur Github</span>
                            </li>
                            <li>
                                <svg viewBox="0 0 30 30" width="24" height="24" fill="#b71968">
                    ...
                    <div className="card border-light mb-3" style={{width: '600px'}}>
                        <div className="card-body">
                            ...
                            <ul>
                                ...
                                <li><strong>Outils :</strong> jQuery, REACT, LESS, SASS, Three.JS, Boostrap, Custom, NPM, WebPack, Grunt, ...</li>
                                <li><strong>Logiciels :</strong> Visual Studio Code, CodeSandbox, Photoshop, Illustrator, Média encoders, Wordpress, ...</li>
                                <li><strong>Services :</strong> Google Cloud, Facebook App, Amazon AWS, CloudFlare, ...</li>
